    ...
    enum MCPWindowToolsLinuxCoordinator {
        static func createHeadlessDependencies(window: WindowState) -> MCPWindowToolDependencies {
            ...
            return MCPWindowToolDependencies(
                ...
                mapFileManagerErrorToMCP: { error, action, _ in
                ...
                performFileAction: { action, path, content, newPath, _ in
                ...
                buildCodeStructureDTO: { _, _, _, _ in
        ...
        static func registerHeadlessMCPWindowTools(window: WindowState) {
            ...
            let runtime = MCPWindowToolRuntime(windowID: window.windowID) { name, _, _, args, implementation in
